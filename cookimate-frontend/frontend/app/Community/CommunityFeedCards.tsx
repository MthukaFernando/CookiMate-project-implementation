          ...
          <View style={styles.reportCard}>
            {showAlreadyReported ? (
              <View style={styles.thankYouArea}>
                <Ionicons name="flag" size={60} color={theme.error} style={{ marginBottom: 15 }} />
                <Text style={[styles.thankYouTitle, { color: theme.error }]}>Already Reported</Text>
                <Text style={styles.thankYouText}>
                  You've already reported this post. Our team will review it shortly.
                </Text>
                <TouchableOpacity
                  style={[styles.modalBtn, { backgroundColor: theme.error, marginTop: 10, width: "100%" }]}
                  onPress={closeReportModal}
                >
                  <Text style={[styles.modalBtnText, { color: "#FFF", textAlign: "center" }]}>Got It</Text>
                </TouchableOpacity>
              </View>
            ) : showThankYou ? (
              <View style={styles.thankYouArea}>
                ...
                <Text style={styles.thankYouText}>
                  Thank you for helping keep our community safe. Our team will review this content shortly.
                </Text>
                <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  dropdown: {
    position: "absolute", left: 10, right: 10, backgroundColor: theme.card,
    borderRadius: 15, elevation: 5, padding: 10, zIndex: 1000,
    borderWidth: 1, borderColor: theme.border,
  },
  resultItem: {
  ...
  card: {
    width: width * 0.92, backgroundColor: theme.card, borderRadius: 25,
  ...
  commentOverlay: {
    ...
    borderTopWidth: 1, borderTopColor: theme.gold,
  },
  overlayHeader: {
    flexDirection: "row", justifyContent: "space-between", marginBottom: 10,
    borderBottomWidth: 0.5, borderBottomColor: theme.border, paddingBottom: 5,
  },
  ...
  bottomInputContainer: {
    ...
    borderRadius: 15, paddingHorizontal: 12, paddingVertical: 10,
    marginTop: 15, borderWidth: 1, borderColor: theme.border,
  },
  ...
  reportCard: {
    width: "88%", backgroundColor: theme.card, borderRadius: 25, padding: 20,
    borderWidth: 1, borderColor: theme.gold,
  ...
  modalHeader: {
    ...
    marginBottom: 15, borderBottomWidth: 0.5, borderBottomColor: theme.border, paddingBottom: 10,
  },
  ...
  modalTextInput: {
    backgroundColor: "#000", color: theme.text, borderRadius: 12, padding: 15,
    height: 120, textAlignVertical: "top", borderWidth: 1, borderColor: theme.border, fontSize: 14,
  },
