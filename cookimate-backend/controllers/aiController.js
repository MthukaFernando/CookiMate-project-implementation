    ...
    try {
        ...
        const chatCompletion = await groq.chat.completions.create({
            messages: [
                { 
                    role: "system", 
                    content: "You are a Master Chef. Provide a recipe. The first line MUST be just the recipe title without any symbols." 
                },
                { 
                    role: "user", 
        ...
        res.status(500).json({ error: "The Chef is currently offline. Please try again." });
    }
};